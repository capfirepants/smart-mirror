(function(angular) {
    ...
    function MirrorCtrl(
        ...
        _this.init = function() {
            ...
            AnnyangService.addCommand('Stop listening', function() {
                console.debug("Ok, my ears are now deactivated");
                $scope.debug = true;
                switch = false;
            });     
            AnnyangService.addCommand('Start listening', function() {
                console.debug("Ok, I'm all ears"); //pun
                $scope.debug = true;
                switch = true;
            });                      

            //Check if the Switch is activated. If not, don't do anything.
            if (switch) {
